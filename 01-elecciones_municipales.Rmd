...
df_n_periodos <- df_completa_incumbente %>% 
  ...
  mutate(periodos_consecutivos_coalicion = hutilscpp::cumsum_reset(reeleccion_coalicion_alcalde >= 1,
         ...
         periodos_consecutivos_coalicion_a = if_else(fecha == 1992, 0, periodos_consecutivos_coalicion+1),
         periodos_consecutivos_coalicion_b = if_else(fecha == 1992, 0, lag(periodos_consecutivos_coalicion))) 
...
- Número de candidatos por coalición.
...
df_n_candidatos pegarla al final = contiene información sobre el n de candidatos por coalición.
