...
df_elect_and_incumbent <- df_join %>% 
  mutate(coalicion_persona_incumbente = if_else(reeleccion_alcalde == 1, coalicion_pm, coalicion_incumbente),
...
write_dta(df_final, "data/231129 - Elecciones municipales.dta")
write_rds(df_final, "data/231129 - Elecciones municipales.rds")
write_sav(df_final, "data/231129 - Elecciones municipales.sav")

writexl::write_xlsx(df_final, "data/revisión.xlsx")
```

Falta sexo en algunas comunas

Falta revisión del incumbente en algunas comunas 2021
